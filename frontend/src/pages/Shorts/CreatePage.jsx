...
function CreatePage() {
  ...
  const selectedOption = option.find((opt) => opt.id === selected)
        ...
        {!selected ? (
          <div>
            ...
            <p className='text-gray-400 text-sm text-center'>
              Upload and record from home or on the go. Everything you make public will appear here.
            </p>
          </div>
        ) : (
          <div className='flex flex-col items-center justify-center gap-1'>
            ...
            <p className='text-gray-400 text-sm text-center'>
              Click below to start your {selectedOption?.title}
            </p>
