...
function Subscription() {
  ...
  return (
    <div className="px-6 py-4 min-h-screen mt-[50px]">
      ...
      {subscribedChannels.length > 0 && (
        <>
          <h2 className="text-2xl font-bold mb-6 border-b border-gray-700 pb-2">Subscribed Channels</h2>
          <div className="flex gap-6 overflow-x-auto pb-6 scrollbar-hide">
            {subscribedChannels.map((ch) => (
              ...
              >
                <img src={ch?.avatar} alt={ch?.name} className="w-20 h-20 rounded-full object-cover border border-gray-600 shadow-md" />
      ...
      {subscribedVideos.length > 0 && (
        <>
          <h2 className="text-2xl font-bold mb-6 mt-8 border-b border-gray-700 pb-2 flex items-center gap-2">
      ...
      {(subscribedPosts || []).length > 0 && (
        <>
          <h2 className="text-2xl font-bold mb-6 mt-8 border-b border-gray-700 pb-2 flex items-center gap-2">
            <RiUserCommunityFill className="w-6 h-6 text-orange-600" /> Subscribed Posts
          </h2>
